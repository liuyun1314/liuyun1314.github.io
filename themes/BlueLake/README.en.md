...
A simple theme for [Hexo](http://user.qzone.qq.com/1019373672) with great performance on different devices .
...
- If you have any trouble in using this theme, please feel free to open an [issue](http://user.qzone.qq.com/1019373672/issues).
